# Model Selection Report: pm_spot_check (version 1.0.1)
...
| xgboost **(selected)** | 0.925 | 0.602 | 0.746 | 0.667 | 0.933 | 0.761 |

## Selection rationale
**xgboost** was selected because it has the highest PR-AUC (0.761) among candidates, which is the appropriate primary metric given the high-risk class is the minority class. Recall is used as the tie-breaker. Accuracy was not used as the deciding factor (section 33).
